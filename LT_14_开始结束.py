...
class Game:
    def __init__(self):
        ...
        enemy_plane2 = EnemyPlane("res/img-plane_5.png", random.randint(0, WINDOW_WIDTH - 100), random.randint(-150, -68),
                                  self.window)
        enemy_plane3 = EnemyPlane("res/img-plane_5.png", random.randint(0, WINDOW_WIDTH - 100), random.randint(-300, -140),
                                  self.window)
